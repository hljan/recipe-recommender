...
class PyNeoGraph:
    ...
    def get_relevant_ingredients(self, user_id, recipe_id):
        # TODO: implement the query
        results = recipe_id
        # query = """
        #         """
    ...
    def match_recipes(self, ingredients, user_id):
        """
            Using neo4j library
        ...
        df = self.driver.run(query, {"ingredients": ingredients}).to_data_frame()
        return df
